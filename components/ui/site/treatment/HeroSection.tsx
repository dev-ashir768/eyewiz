        ...
        <section className='container min-h-screen flex flex-col justify-evenly bg-[#0C0C0C] pt-[143px] lg:pb-0 pb-10 w-full h-full gap-8'>
            <div className='flex lg:flex-row flex-col lg:justify-between lg:items-center gap-10'>
                <div className='lg:w-[51%] w-full'>
                    ...
                    <p className='text-[#9F9F9F] xxl:text-lg sm:text-base text-sm'>🔮 Vision Correction & Care</p>
                    <p className='text-[#9F9F9F] xxl:text-lg sm:text-base text-sm'>🧐 Comprehensive Eye </p>
                    <p className='text-[#9F9F9F] xxl:text-lg sm:text-base text-sm'>👓 Prescription Eyewear</p>
                </div>
